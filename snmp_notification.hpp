...
class OBMCErrorNotification : public Notification
{
    ...
    public:
        ...
        OBMCErrorNotification(uint32_t id, uint64_t ts, int32_t sev,
                          std::string msg) :
            OBMCErrorID(id), OBMCErrorTimestamp(ts),
            OBMCErrorSeverity(sev), OBMCErrorMessage(msg) {}
    ...
    protected:
        ...
        std::pair<OID, OID_LEN> getTrapOID() override
        {
            ...
            OID id =  {1, 3, 6, 1, 4, 1, 49871, 1, 0, 1};
            OID_LEN idLen = 10;
